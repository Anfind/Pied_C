...
int main(){
    ...
    printf("Chuong Trinh Tinh Bieu Thuc\n");
    printf("\033[32m===========================\033[0m\n");
    while(again == 'Y' || again == 'y'){
        char bieu_thuc[1000] ={0};
        printf("\n>> Nhap bieu thuc di ban [vd: 3+5*(7-2)]:  ");
        fflush(stdin);
        scanf("%s", bieu_thuc);
        ...
        printf("\n\033[32m>> Ket qua: %d\033[32m", stack_giatri[first_giatri]);
        reTry:printf("\033[33m\nBan muon choi nua hong?? [Y/N] ");
        fflush(stdin);
        fflush(stdout);
        scanf("%c", &again);
    }
